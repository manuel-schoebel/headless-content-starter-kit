...
export interface ApiFaqFaq extends Schema.CollectionType {
  ...
  attributes: {
    name: Attribute.String;
    questions: Attribute.Component<'elements.question-and-answer', true>;
...
export interface ApiGlobalGlobal extends Schema.SingleType {
  ...
  attributes: {
    ...
    footer: Attribute.DynamicZone<
      ['elements.rich-text', 'navigation.link-list']
    >;
...
export interface ApiHierarchyHierarchy extends Schema.CollectionType {
...
export interface ApiMenuItemMenuItem extends Schema.CollectionType {
  ...
  attributes: {
    ...
    components: Attribute.DynamicZone<
      ['navigation.link-list', 'content.page-preview-list']
    > &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
...
export interface ApiSidebarLayoutSidebarLayout extends Schema.CollectionType {
  collectionName: 'sidebar_layouts';
  info: {
    singularName: 'sidebar-layout';
    pluralName: 'sidebar-layouts';
  ...
  attributes: {
    stickySidebar: Attribute.Boolean &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    sidebarComponents: Attribute.DynamicZone<
      ['navigation.link-list', 'navigation.table-of-contents']
    > &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
    ...
    contentComponents: Attribute.DynamicZone<
      [
        'content.section-headline',
        'elements.rich-text',
        'content.video',
